...
| AI REVIEW | 매일 00:30 KST | Claude Code가 최신 통계를 근거로 3~4줄 평가 재작성 |
...
- **Codex** — 디자인 디렉션과 리뷰. 실제 화면, 이미지, 보안, 접근성, 구현 방식을 검토합니다 (`AGENTS.md`)
- **Claude Code** — 구현. Codex 명세를 바탕으로 콘텐츠와 코드를 수정하고 PR을 준비합니다 (`CLAUDE.md`)
