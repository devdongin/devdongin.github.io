...
대표 서사는 **"Vision AI 영상보안 솔루션 SEEUON을 연구실 모델에서 고객사 운영 환경까지 제품화한 엔지니어"**다. 커널 드라이버·Credential Provider·후킹/인젝션·배포 파이프라인은 *그 제품을 보호하고 운영하기 위해 확장한 차별점*으로 배치한다 — "커널도 하는 사람"이 아니라 "제품을 고객 환경에서 살려본 사람"으로 읽혀야 한다. 이 축을 바꾸지 말 것 (주간 AI REVIEW 프롬프트에도 동일 지시 포함).
